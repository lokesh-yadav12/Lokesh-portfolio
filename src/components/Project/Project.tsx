          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/lokesh-yadav12/AtoZfarming" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
                <a href="https://ato-zfarming.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>FarmStack Ai </h3>
              <p>
                FarmStack Ai is a comprehensive, full-stack agricultural platform built with React, Node.js, and MongoDB. It offers farmers a range of smart tools like crop disease detection, weather forecasting, marketplace integration, and AI-powered recommendations.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/lokesh-yadav12/ClothNest" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://cloth-nest-iota.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> 
                </div>
            </header>
            <div className="body">
              <h3>ClothNest</h3>
              <p> ClothNest is a fully responsive e-commerce platform built for modern fashion brands. It offers a seamless online shopping experience with dynamic product listings, cart management, and smooth navigation across all devices. </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/lokesh-yadav12/Blog-app" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://blog-app-taupe-beta.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Blog-app</h3>
              <p>
                A feature-rich blogging platform built with Next.js and TypeScript, offering a clean and responsive UI. Users can explore posts, save their favorite articles, and leave comments. Designed with modern UI principles using Tailwind CSS, the app ensures smooth navigation and an engaging reading experience on all devices..
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>A comprehensive invoice generation solution designed for businesses of all sizes. Create professional, GST-compliant invoices instantly with automated calculations and customizable templates.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/lokesh-yadav12/Restaurant-management-system" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://restaurant-management-system-brown.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>EZCHEF</h3>
              <p>Developed a full-stack Restaurant Management System using React.js, Node.js, Express.js, and MongoDB to streamline restaurant operations. Features include order management, menu handling, table reservations, and billing with a responsive UI.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/lokesh-yadav12/Travel-website" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://travel-website-five-sable.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>ExploreEase</h3>
              <p>
               ExploreEase is a comprehensive, user-friendly travel platform designed to transform the way you plan and experience your journeys around the world. Whether you're a seasoned globetrotter or planning your first adventure, ExploreEase brings the world to your fingertips with seamless booking, personalized recommendations, and curated travel experiences.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        {/* <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://velocitycom/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
